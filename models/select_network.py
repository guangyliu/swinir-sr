...
def define_G(opt):
    opt_net = opt['netG']
    net_type = opt_net['net_type']  # swinir or SwinRefSR
    ...
    # ----------------------------------------
    # SwinTransRefSR by zwb
    elif net_type == 'SwinRefSR':
        from models.network_SwinRefSR import SwinRefSR as net
        netG = net(upscale=opt_net['upscale'],  # 4
                   in_chans=opt_net['in_chans'],  # 3
                   img_size=opt_net['img_size'],  # 160
    ...
    # ----------------------------------------
    # Swin Baseline by zwb - Zhen Li's idea of baseline
    elif net_type == 'Swin_baseline':
        from models.network_SwinConcate2 import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
